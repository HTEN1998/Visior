	...
	def compass(self,input_direction):
		...
		while (count<2):
			...
			if(self.left_sensor==0 and self.right_sensor==0):	#no block detected in left and right
				...
				# comparing the left and right distance given by sensor
				if (left_tuple[1]<right_tuple[1]):	# move left is compass angle is near to 360 or 0 degree
				...
				elif(left_tuple[1]>=right_tuple[1]):
