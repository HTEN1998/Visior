...
class CameraMotion:
	...
	def ResetCameraPosition(self , caller = None):
		try:
			...
			print(f"Exception in <Class> - CameraMoition  <Function> -  ResetCameraPosition  <File> - CameraMotion  -> {e}")
			pass
	...
	def CameraMotionTest(self):
		try:
			...
			print(f"Exception in <Class> - CameraMoition  <Function> -  CameraMotionTest  <File> - CameraMotion  -> {e}")
			pass
	...
	def RemoteController(self , rec_key ):
		try:
			...
			print(f"Exception in <Class> - CameraMoition  <Function> -  RemoteController  <File> - CameraMotion  -> {e}")
			pass
...
# 		Cm.RemoteController("'a'")
# 		print("Sent a")
# 		#sleep(1)
# 	for i in range(0,20,1):
# 		Cm.RemoteController("'d'")
# 		print("Sent d")
# 		#sleep(1)
